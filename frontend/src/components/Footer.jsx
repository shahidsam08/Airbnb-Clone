...
function Footer() {
  return (
    <div className="bg-gray-100 px-5 lg:px-10 pt-12 lg:pb-20">
      <div className="lg:flex lg:flex-row lg:justify-start lg:gap-40">
        <div className="border-b-[0.6px] border-gray-400 flex flex-col gap-3 mt-3 pb-5 lg:border-hidden">
        ...
        {/* hosting */}
        <div className="border-b-[0.5px] border-gray-400 flex flex-col gap-3 mt-3 pb-5 lg:border-hidden">
        ...
        <div className="border-b-[0.5px] lg:border-hidden border-gray-400 flex flex-col gap-3 mt-3 pb-5">
      ...
      <div className="lg:border-b-[0.5px] lg:border-gray-400"></div>

      {/* currency and language of the airbnb. */}
      <div className="mt-6 flex flex-col gap-4 lg:flex-row-reverse lg:justify-between lg:px-10 lg:items-start">
        ...
        <div className="mb-5 lg:flex-row lg:flex lg:items-center lg:gap-2">
