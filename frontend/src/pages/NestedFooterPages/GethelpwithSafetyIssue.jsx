      ...
      <div className="md:flex md:justify-center md:">
        <div className="pb-20 md:w-[70%]">
          <div className="px-3 pt-12 pb-22 flex flex-col gap-5 ">
            <Link to="/helpcenter" className="hidden md:flex md:items-center gap-2 ">
            ...
            <p className="text-[1.2rem] font-light text-gray-800">
              This will help us quickly identify you and get you the right kind
              of help
            </p>
            <div className="flex flex-row gap-2">
              <Link to="/login" className="bg-[#008489] text-white font-medium px-7 py-3 text-[1.2rem] rounded-[0.3rem]">
                Log In
              </Link>
              <Link to="/login" className="font-extrabold px-7 py-3 text-[1.2rem] rounded-[0.3rem] border-2 border-[#008489] text-[#008489]">
                Sign Up
              </Link>
            </div>
          </div>
