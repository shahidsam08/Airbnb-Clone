...
function AntiDiscrimination() {
  return (
    <div>
      <div className="px-5 flex flex-col gap-6 pb-15">
        {/* Airbnb logo */}
        <div className="py-5">
          <Link to="/">
        ...
        <div className="flex flex-col items-center text-center py-8 gap-2">
          ...
          <p className="text-[1.05rem] text-gray-700">
            ...
            users of different perceived races may experience Airbnb. We
            developed Project Lighthouse with guidance from a number of leading
            civil rights and privacy organisations.{" "}
        ...
        <div className="flex flex-col gap-8 pb-6">
          ...
          <div>
            ...
            <p className="text-[0.9rem] text-gray-800">
              ...
              the booking process by supporting more objective bookings. Recent
          ...
          <div>
            ...
            <p className="text-[0.9rem] text-gray-800">
              ...
              made it easier for guests to add co-travellers with Airbnb
          ...
          <div>
            ...
            <p className="text-[0.9rem] text-gray-800">
              ...
              who report being identified by the incorrect pronoun in a review.
              If a host or guest expresses this concern, the pronoun is replaced
          ...
          <div>
            ...
            <p className="text-[0.9rem] text-gray-800">
              Our accessibility feature search filters make it easier for guests
              to find and book stays that meet their needs. Through
        ...
        <div className="text-center flex flex-col gap-4 pb-10">
          ...
          <div className="px-6 py-4 rounded-2xl bg-pink-100 ">
            <p className="text-[1.2rem] font-bold text-gray-800 leading-6">
              I will treat everyone in the community – regardless of their race,
              religion, national origin, ethnicity, skin colour, disability,
        ...
        <div className="flex flex-col gap-6 pt-6 pb-8">
          <div className="text-center flex flex-col gap-2">
            <p className="text-[1.4rem] font-semibold">Read the 2024 report</p>
            <p className="text-[1.1rem]">
              The 2024 Project Lighthouse Update includes key Project Lighthouse
              findings and our complete data set as well as progress we’ve made
              since 2016.
            </p>
          </div>
          <div>
            <button className="bg-[#DA1249] rounded-3xl w-full py-3 text-white text-[1.1rem]">
              Show report
            </button>
          </div>
        ...
        <div className="border-[0.02px] text-gray-300"></div>
        {/* Meet our partners */}
        <div className="text-center pt-6 flex flex-col gap-8">
