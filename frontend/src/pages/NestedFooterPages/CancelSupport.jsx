...
function CancelOption() {
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="flex flex-row items-center align-middle justify-between px-6 py-4 border-b-[0.3px]">
      ...
      <div className="px-8 flex flex-col gap-14">
        ...
        <div className="flex flex-row items-center align-middle gap-3">
          ...
          <p className="underline text-gray-700 text-[0.9rem]">Cancellations</p>
        </div>
        {/* community policy */}
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            In the rare circumstances that large-scale events prevent or legally
            prohibit completion of a reservation, the Major Disruptive Events
            Policy (the “Policy”) may apply. When this Policy applies, guests
            can cancel their reservation and receive a refund, travel credit
            and/or other consideration regardless of the reservation’s{" "}
            <span className="underline font-medium text-black">
              cancellation policy.
            </span>{" "}
            and{" "}
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            example, the flu) or commonly associated with an area (for example,
            malaria in Thailand). COVID-19 is not covered under this Major
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            Mandatory travel restrictions imposed by a governmental agency, such
            as an evacuation order or lockdown order. This does not include
            non-binding travel advisories and similar government guidance.
          </p>
          <p className="text-[1.1rem] text-[#504f4f]">
            <span className="font-bold text-black">
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            Unforeseeable natural disasters and severe weather events.
            Unforeseeable natural disasters, like earthquakes and tsunamis, and
            unforeseeable severe weather events, like tornadoes. This does not
            include events that are foreseeable for a given location, as
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            determine whether the Major Disruptive Events Policy applies. If it
            does, we activate the Policy for the affected area and timeframe
            where we anticipate that the Event will prevent or legally prohibit
            completion of reservations. Reservations outside of the defined area
            and timeframe may not be eligible although{" "}
            <span className="font-medium text-gray-800 underline">
              hosts may still be able to cancel without adverse consequences if
        ...
        <div className="flex flex-col gap-5">
          ...
          <ul className="flex flex-col gap-2 list-disc pl-10">
            <li>
              Events that affect a guest or their ability to travel, but not the
            ...
            <li>
              Cancellation or rescheduling of an event for which the reservation
              was made
            </li>
            <li>
            ...
            <li>
              ...
              the event triggers a covered Event that prevents completion of the
              reservation, such as government-issued mandatory travel
              restrictions
            </li>
          </ul>
          <p className="text-[1.1rem] text-[#202020] font-light">
            For reservations not covered by this Policy, we encourage guests and
            hosts to find a mutually acceptable arrangement, such as a full or
            partial refund or an alteration of the booking dates. Note that any
            refunds outside of the reservation’s cancellation policy are at the
            host’s discretion. Airbnb does not take part in or guarantee such
            refunds.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[1.1rem] text-[#504f4f]">
            ...
            receive a payout for the cancelled dates of the reservation, or, if
            the payout has already been made, the refunded amount will be
            withheld from the next payout(s).
          </p>
          <p className="text-[1.1rem] text-[#504f4f]">
            Regardless of whether a reservation is covered by this Policy, hosts
            can cancel for certain{" "}
            <span className="font-semibold text-gray-900 underline">
              valid reasons,
            </span>{" "}
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[1.1rem] text-[#201f1f]">
            This Policy does not limit your rights under local regulations, and
            any decisions made by Airbnb under this Policy do not affect your
            statutory rights.
          </p>
        </div>
          ...
          {isHelpful === "yes" ? (
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[#555454]">Please select all that apply.</p>
              </div>
